...
namespace Microsoft.HealthVault.ItemTypes
{
    ...
    public class BlueButtonTextFile : ThingBase
    {
        ...
        protected override void ParseXml(IXPathNavigable typeSpecificXml)
        {
            ...
            Validator.ThrowInvalidIfNull(itemNav, Resources.BlueButtonTextFileUnexpectedNode);
        ...
        public override void WriteXml(XmlWriter writer)
        {
            ...
            {
                throw new ThingSerializationException(Resources.BlueButtonTextFileNameNotSet);
            }
            ...
            CodableValue contentType)
        {
            ...
            Validator.ThrowIfArgumentNull(contentType, nameof(contentType), Resources.BlueButtonFileContentTypeNotSet);
            ...
            CodableValue contentType)
        {
            ...
            Validator.ThrowIfArgumentNull(contentType, nameof(contentType), Resources.BlueButtonStreamContentTypeNotSet);

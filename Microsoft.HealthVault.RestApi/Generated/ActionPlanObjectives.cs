...
namespace Microsoft.HealthVault.RestApi.Generated
{
    ...
    public partial class ActionPlanObjectives : IServiceOperations<MicrosoftHealthVaultRESTAPI>, IActionPlanObjectives
    {
        ...
        public async Task<HttpOperationResponse> DeleteWithHttpMessagesAsync(System.Guid actionPlanId, System.Guid objectiveId, Dictionary<string, List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            _url = _url.Replace("{objectiveId}", System.Uri.EscapeDataString(Rest.Serialization.SafeJsonConvert.SerializeObject(objectiveId, Client.SerializationSettings).Trim('"')));

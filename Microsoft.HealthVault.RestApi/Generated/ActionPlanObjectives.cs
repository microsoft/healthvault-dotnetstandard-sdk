...
namespace Microsoft.HealthVault.RestApi.Generated
{
    ...
    public partial class ActionPlanObjectives : IServiceOperations<MicrosoftHealthVaultRestApi>, IActionPlanObjectives
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<object>> DeleteWithHttpMessagesAsync(string actionPlanId, string objectiveId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {

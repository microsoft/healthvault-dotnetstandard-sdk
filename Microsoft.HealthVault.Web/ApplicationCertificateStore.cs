...
namespace Microsoft.HealthVault.Application
{
    internal sealed class ApplicationCertificateStore
    {
            ...
            string certFilename)
        {
            ...
            // set to null.
            string password = null; //this.configuration.ApplicationCertificatePassword;
            ...
            string certSubject)
        {
            ...
            string applicationCertificateFilename = null; // this.configuration.ApplicationCertificateFileName;
        ...
        {
            // TODO: fix as part of web api
            string result = null; // this.configuration.CertSubject;

...
namespace Microsoft.HealthVault.Web
{
    ...
    public class ThingDataGrid : Control, INamingContainer
    {
        ...
        protected void PopulateGridView()
        {
            ...
            ThingQuery query = queryOverride;

            if (query == null)
            {
                query = this.BuildFilterFromParams();
            }
        ...
        /// <summary>
        /// Builds the filter used to populate the data grid. The query is
        ...
        /// </returns>
        ///
        private ThingQuery BuildFilterFromParams()
        {
            ThingQuery query = new ThingQuery();
            foreach (Guid typeId in TypeIds)
            {
                query.TypeIds.Add(typeId);
            }
            return query;
        }
        ...
        /// </remarks>
        ///
        public ThingQuery QueryOverride
        {
            get { return queryOverride; }
            set { queryOverride = value; }
        }
        private ThingQuery queryOverride;
        ...
        /// <br/>
        /// If the <see cref="QueryOverride"/> property is set, this property
        /// is ignored.
        /// </remarks>
        ///
